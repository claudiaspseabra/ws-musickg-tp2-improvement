...
from music_graph.sparql_queries import _PREFIXES, _resource_slug, _round, _slug
...
def get_recommendations(artist_slug: str) -> Dict:
    ...
    """
    return _engine.recommend(f"http://musickg.org/artist/{_resource_slug(artist_slug)}")
